  ...
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <div class="flex justify-between h-16 items-center">
      ...
      <div class="hidden sm:flex sm:space-x-4">
        ...
        <a href="{{route("signin")}}" class="text-white hover:bg-gray-700 px-3 py-2 rounded-md text-sm font-medium">Sign in </a>
        <a href="{{route("signup")}}" class="text-white hover:bg-gray-700 px-3 py-2 rounded-md text-sm font-medium">Sign up</a>
        <a href="/admin" class="text-white hover:bg-gray-700 px-3 py-2 rounded-md text-sm font-medium">Admin</a>
